...
extension _Styles on InAppNotificationWidgetStyle {
  Widget get prefixIcon {
    return switch (this) {
      InAppNotificationWidgetStyle.error => Assets.notification.iconNotificationError.svg(),
      InAppNotificationWidgetStyle.success => Assets.notification.iconNotificationSuccess.svg(),
      InAppNotificationWidgetStyle.warning => Assets.notification.iconNotificationWarning.svg(),
      InAppNotificationWidgetStyle.info => Assets.notification.iconNotificationInfo.svg(),
    };
  }
